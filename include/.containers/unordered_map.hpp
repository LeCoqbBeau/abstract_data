...
# define UMAP_PROTOTYPE(ret, prototype, reference)											\
	template <class Key, class T, class Hash, class KeyEqual, class Allocator>				\
	ret prototype																			\
	(ft::unordered_map<Key, T, Hash, KeyEqual, Allocator> reference lhs,					\
	ft::unordered_map<Key, T, Hash, KeyEqual, Allocator> reference rhs)
# define UMMAP_PROTOTYPE(ret, prototype, reference)											\
	template <class Key, class T, class Hash, class KeyEqual, class Allocator>				\
	ret prototype																			\
	(ft::unordered_multimap<Key, T, Hash, KeyEqual, Allocator> reference lhs,				\
	ft::unordered_multimap<Key, T, Hash, KeyEqual, Allocator> reference rhs)
# define UNORDERED_MAPS_PROTOTYPE(ret_type, proto, ref, stmt)								\
	UMAP_PROTOTYPE(ret_type, proto, ref) stmt UMMAP_PROTOTYPE(ret_type, proto, ref) stmt

UNORDERED_MAPS_PROTOTYPE(bool, operator==, CREF, { return lhs.size() == rhs.size() && ::ft::is_permutation(lhs.begin(), lhs.end(), rhs.begin()); })
UNORDERED_MAPS_PROTOTYPE(bool, operator!=, CREF, { return !(lhs == rhs); })
UNORDERED_MAPS_PROTOTYPE(void, swap, REF, { return lhs.swap(rhs); })

#undef UNORDERED_MAPS_PROTOTYPE
#undef UMMAP_PROTOTYPE
#undef UMAP_PROTOTYPE
