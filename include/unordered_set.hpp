...
> class unordered_set
{
	...
	public:
		...
		// Constructors
#define UST_DEFAULT_PARAMETERS_DECL size_type n = HASHMAP_INIT_SIZE, hasher CREF hash = hasher(), key_equal CREF equal = key_equal(), allocator_type CREF allocator = allocator()
		...
		// Modifiers
		ft::pair<iterator, bool>				insert(value_type CREF value);
