...
#ifndef DEQUE_ITERATORS_H
#define DEQUE_ITERATORS_H

#include ".helper/iterator.h"

template<class T, class Allocator>
class ft::deque<T, Allocator>::const_iterator : public ft::iterator<bidirectional_iterator_tag, value_type> {
	public:
		...
		// Attributes
		_block_t	_curr;
		_block_t	_curr_begin;
		_block_t	_curr_end;
		_map_t		_current_block;

};

template<class T, class Allocator>
class ft::deque<T, Allocator>::iterator : public const_iterator {
	public:
		// Constructor
