...
#ifndef HCT_CONSTRUCTORS_TPP
#define HCT_CONSTRUCTORS_TPP


template <typename Container>
class hctConstructorTests : public ::testing::Test {};


TYPED_TEST_CASE_P(hctConstructorTests);


TYPED_TEST_P(hctConstructorTests, Default)
{
	TypeParam container;
...
TYPED_TEST_P(hctConstructorTests, Range)
{
	...
	EXPECT_TRUE(std::is_permutation(array(), array() + ARRAY_TINY, c.begin()));
}


TYPED_TEST_P(hctConstructorTests, Copy)
{
	typedef typename TypeParam::value_type	value_type;
	typedef typename TypeParam::size_type	size_type;
	arrayGenerator<value_type>				array;
	...
	EXPECT_TRUE(std::is_permutation(array(), array() + ARRAY_TINY, src.begin()));
	// Actual tests
	TypeParam dest(src);
	EXPECT_EQ(dest, src);
	{
...
TYPED_TEST_P(hctConstructorTests, AssignementOperator)
{
	typedef typename TypeParam::value_type		value_type;
	typedef typename TypeParam::size_type		size_type;
	arrayGenerator<value_type>					array;
